    ...
    <main className="min-h-screen bg-[var(--color-canvas)]">
      ...
      <section className="apple-tile-light py-24 sm:py-32 border-b border-[var(--color-divider-soft)] relative overflow-hidden">
        ...
        <div className="page-container relative z-10 flex flex-col items-center text-center">
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-[var(--radius-lg)] bg-[var(--color-bg-secondary)] border border-[var(--color-hairline)] mb-6">
        ...
        <div className="page-container max-w-xl">
          <div className="bg-[var(--color-surface-elevated)] border border-[var(--color-hairline)] rounded-[var(--radius-lg)] p-6 sm:p-10">
            <form action={formAction} className="flex flex-col gap-6">
              ...
              {/* Status Messages */}
              {state.success && (
                <div className="flex items-start gap-3 rounded-[var(--radius-md)] bg-emerald-500/10 border border-emerald-500/20 p-4 text-emerald-600 dark:text-emerald-400">
              ...
              {state.error && (
                <div className="flex items-start gap-3 rounded-[var(--radius-md)] bg-red-500/10 border border-red-500/20 p-4 text-red-600 dark:text-red-400">
              ...
              <button
                type="submit"
                disabled={isPending}
                className="group relative flex h-11 w-full items-center justify-center gap-2 overflow-hidden rounded-[var(--radius-pill)] bg-[var(--color-action-blue)] text-white text-sm font-medium transition-all duration-300 hover:bg-[var(--color-action-blue-focus)] active:scale-[0.95] disabled:opacity-70 disabled:pointer-events-none mt-2 cursor-pointer"
              >
                {isPending ? (
                  <>
